...
@Feature("VIP Visit")
public class CreateVIPVisitRequestTest extends BaseTest {
    private static final DateTimeFormatter TIME_FORMAT = DateTimeFormatter.ofPattern("hh:mm a", Locale.ENGLISH);

    @Story("Create VIP Request")
    @Severity(SeverityLevel.CRITICAL)
    @Test(description = "Create VIP Visit", groups = {"smoke", "regression", "visit", "vip"})
    public void createRegularVisitRequest() {
        ...
        String accessToken = AuthClient.login(TestConfig.VIP_USERNAME, TestConfig.VIP_PASSWORD);
        ...
        loginPage.login(TestConfig.VIP_USERNAME, TestConfig.VIP_PASSWORD);
